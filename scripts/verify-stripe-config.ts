...
console.log(`Price IDs Configured:  ${config.configuredPriceCount} / ${STRIPE_PRICE_ENV_KEYS.length}`);
...
console.log(`Webhook Secret: ${process.env.STRIPE_WEBHOOK_SECRET ? "LOADED (" + process.env.STRIPE_WEBHOOK_SECRET.substring(0, 12) + "...)" : "MISSING"}`);
