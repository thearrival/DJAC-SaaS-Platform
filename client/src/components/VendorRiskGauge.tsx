...
export function VendorRiskGauge() {
  ...
  const copy = {
    en: {
      title: "Vendor",
      accent: "Risk Scores",
      subtitle: "Composite compliance scores across all frameworks",
      low: "low",
      medium: "medium",
      high: "high",
      critical: "critical",
    ...
    ar: {
      title: "مخاطر",
      accent: "الموردين",
      subtitle: "درجات الامتثال المركبة عبر جميع الأطر",
      low: "منخفض",
      medium: "متوسط",
      high: "مرتفع",
      critical: "حرج",
          ...
          >
            <div className="flex items-center justify-between mb-1.5">
              <motion.span
                ...
                animate={
                  hoveredIdx === i ? { color: "hsl(185, 100%, 49%)" } : {}
                }
              >
                {v.vendorName}
              </motion.span>
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`text-[9px] font-mono uppercase px-1.5 py-0.5 rounded-full border ${riskBorder(v.risk)} text-muted-foreground`}
                >
                  {riskLabel(v.risk)}
                </span>
              </div>
            ...
            <div className="w-full h-2 bg-muted rounded-full overflow-hidden relative">
              <motion.div
                ...
                style={{
                  boxShadow: hoveredIdx === i ? riskGlow(v.risk) : "none",
                }}
              >
                {/* Shimmer */}
                <motion.div
