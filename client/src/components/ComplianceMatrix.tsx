        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-center py-2 px-2 text-muted-foreground font-mono uppercase tracking-wider text-[10px]">
                {copy.risk}
              </th>
            </tr>
          </thead>
          <tbody>
            {matrixData.map((row, i) => (
              ...
              >
                <td className="py-2.5 px-2 text-foreground/80 font-medium">
                  {
                    copy.categories[
                      row.category as keyof typeof copy.categories
                    ]
                  }
                </td>
                <td className="py-2.5 px-2">
                  <StatusCell status={row.csl} delay={0.6 + i * 0.08} />
                </td>
                <td className="py-2.5 px-2">
                  <StatusCell status={row.dsl} delay={0.65 + i * 0.08} />
                </td>
                <td className="py-2.5 px-2">
                  <StatusCell status={row.pipl} delay={0.7 + i * 0.08} />
                </td>
                <td className="py-2.5 px-2">
                  <StatusCell status={row.pdpl} delay={0.75 + i * 0.08} />
                </td>
                <td className="py-2.5 px-2">
                  <StatusCell status={row.nca} delay={0.8 + i * 0.08} />
                </td>
                <td className="py-2.5 px-2">
                  <motion.span
