  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <span
            style={{ fontSize: 16, fontWeight: 700, color: "var(--djac-text)" }}
          >
            {code}
          </span>
          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
            ...
            <ArrowRight
              style={{ width: 11, height: 11, color: "var(--djac-muted)" }}
            />
          </div>
        </div>
        ...
        >
          ...
          <div>
            <span style={{ color: scoreColor, fontSize: 13, fontWeight: 700 }}>
              {score}%
            </span>
            <p style={{ color: "var(--djac-muted)", fontSize: 8.5, margin: 0 }}>
              {relationCount} pairs
            </p>
          </div>
        </div>
