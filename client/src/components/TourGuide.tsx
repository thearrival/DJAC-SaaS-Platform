...
export function TourGuide() {
  ...
  const tipPos = targetRect
    ...
    : {
        top: vpSize.h / 2 - TIP_H / 2,
        left: vpSize.w / 2 - TIP_W / 2,
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={t("tour.dialogLabel", "Onboarding tour")}
    >
        ...
        <>
          ...
          <div
            style={{
              ...
              boxShadow:
                "0 0 0 4px rgba(0,247,255,0.18), 0 0 32px rgba(0,247,255,0.30)",
              pointerEvents: "none",
      ...
      <div
        style={{
          ...
          zIndex: 9999,
          background:
            "linear-gradient(145deg, rgba(8,20,80,0.97) 0%, rgba(4,12,56,0.97) 100%)",
