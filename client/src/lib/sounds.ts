...
export const sounds = {
   ...
   */
  success(): void {
    tone(523, 0.09, "sine", 0.14, 0.004, 0.7, 0);
    tone(659, 0.09, "sine", 0.12, 0.004, 0.7, 80);
    tone(784, 0.18, "sine", 0.1, 0.004, 0.75, 160);
  },
   ...
   */
  notification(): void {
    tone(880, 0.055, "sine", 0.1, 0.003, 0.6, 0);
   ...
   */
  tourStep(): void {
    tone(440, 0.07, "sine", 0.1, 0.003, 0.65, 0);
  ...
  tourComplete(): void {
    ...
    tone(784, 0.08, "sine", 0.1, 0.004, 0.65, 160);
    tone(1047, 0.2, "sine", 0.09, 0.004, 0.75, 240);
  },
   ...
   */
  open(): void {
    tone(600, 0.08, "sine", 0.07, 0.004, 0.7, 0);
    tone(720, 0.07, "sine", 0.06, 0.004, 0.7, 50);
  },
   ...
   */
  close(): void {
    tone(720, 0.07, "sine", 0.06, 0.004, 0.7, 0);
    tone(540, 0.08, "sine", 0.05, 0.004, 0.7, 50);
  },
} as const;
