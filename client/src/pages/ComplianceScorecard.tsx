...
function riskBadge(level: string | null) {
  ...
  const style =
    styles[level ?? ""] ??
    "background:var(--djac-surface);color:var(--djac-muted)";
  return (
    <span
      style={{
        ...(Object.fromEntries(
  ...
  return (
    <Card style={{ flex: 1, minWidth: 140 }}>
      <CardContent style={{ padding: "16px 20px" }}>
        ...
        {sub && (
          <div
            style={{ fontSize: 11, color: "var(--djac-muted)", marginTop: 4 }}
          >
            {sub}
          </div>
        )}
...
export default function ComplianceScorecard() {
  ...
  const { data, isLoading, isError, refetch } =
    trpc.scorecard.orgScorecard.useQuery(undefined, {
  ...
  const totalGaps = data
    ? Object.values(data.gapsBySeverity).reduce((a, b) => a + b, 0)
    : 0;
    ...
    <div className="djac-page">
      ...
      >
        <div>
          ...
          >
            {t(
              "scorecard.subtitle",
              "Organization-wide compliance health overview"
            )}
          </p>
        </div>
        <Button
      ...
      {isError && (
        <Card style={{ marginBottom: 20, borderColor: "var(--djac-red)" }}>
          ...
          >
            <AlertCircle
              style={{ color: "var(--djac-red)", width: 16, height: 16 }}
            />
          ...
          >
            {isLoading ? (
              ...
              >
                <Loader2
                  className="animate-spin"
                  style={{ width: 28, height: 28, color: "var(--djac-muted)" }}
                />
              </div>
            ) : (
              <ScoreGauge
                value={data?.overallScore ?? null}
                color={scoreColor(data?.overallScore ?? null)}
              />
            )}
          </CardContent>
        </Card>
      ...
      >
        ...
        <Card>
          <CardHeader style={{ padding: "16px 20px 8px" }}>
            ...
            <CardDescription style={{ fontSize: 12 }}>
              {t(
                "scorecard.latestPerVendor",
                "Latest assessment per vendor · framework"
              )}
            </CardDescription>
          </CardHeader>
          <CardContent style={{ padding: "0 20px 16px" }}>
            {isLoading ? (
              ...
              >
                <Loader2
                  className="animate-spin"
                  style={{ width: 24, height: 24, color: "var(--djac-muted)" }}
                />
              </div>
        ...
        <Card>
          <CardHeader style={{ padding: "16px 20px 8px" }}>
            ...
            <CardDescription style={{ fontSize: 12 }}>
              {t(
                "scorecard.avgScorePerFramework",
                "Average compliance score per framework"
              )}
            </CardDescription>
          </CardHeader>
          <CardContent style={{ padding: "0 20px 16px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <Card>
            <CardHeader style={{ padding: "16px 20px 8px" }}>
              ...
              >
                <AlertTriangle
                  style={{ width: 14, height: 14, color: "var(--djac-orange)" }}
                />
              ...
              {isLoading ? (
                ...
                <div
                  style={{
                    textAlign: "center",
                    padding: "20px 0",
                    color: "var(--djac-green)",
                    fontSize: 13,
                  }}
                >
                  <CheckCircle2
                    style={{ width: 24, height: 24, margin: "0 auto 6px" }}
                  />
          ...
          <Card>
            <CardHeader style={{ padding: "16px 20px 8px" }}>
              ...
              >
                <FileText
                  style={{ width: 14, height: 14, color: "var(--djac-accent)" }}
                />
              ...
              <TableBody>
                {data.frameworks.map(fw => (
                  <TableRow key={fw.code}>
                    ...
                    <TableCell
                      style={{ fontSize: 13, color: "var(--djac-muted)" }}
                    >
                      {fw.count}
                    </TableCell>
                    <TableCell>
