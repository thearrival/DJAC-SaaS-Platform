...
> = {
  en: {
    ...
    subtitle:
      "Evaluate your organization's readiness for expansion to Saudi Arabia or China",
    sections: {
    ...
    fields: {
      ...
      add: "Add",
      typeAndAddHint:
        "Type value and click Add (or press Enter). You can add multiple values separated by commas.",
      remove: "Remove",
  ...
  zh: {
    ...
    fields: {
      ...
      add: "添加",
      typeAndAddHint:
        "输入值后点击“添加”（或按 Enter）。可用逗号一次添加多个值。",
      remove: "移除",
  ...
  ar: {
    ...
    fields: {
      ...
      add: "إضافة",
      typeAndAddHint:
        "اكتب القيمة ثم اضغط إضافة (أو Enter). يمكنك إضافة عدة قيم مفصولة بفواصل.",
      remove: "إزالة",
...
> = {
  en: {
    ...
    coreSystemsPlaceholder:
      "ERP, CRM, HIS, e-Commerce Platform - separate by comma",
    requiredFieldsNotice:
      "Complete the required fields: Company Name, Industry, and at least one Cybersecurity Framework.",
    recommendedFrameworksTitle: "Recommended frameworks",
    recommendedFrameworksHint:
      "Recommendations are generated from the selected industry, target market, and AI-related activities.",
    applyRecommendedFrameworks: "Apply recommended frameworks",
    recommendationReady:
      "Recommendations update automatically when the industry changes.",
  },
  zh: {
    ...
    requiredFieldsNotice:
      "请填写必填项：公司名称、行业，以及至少一个网络安全框架。",
    recommendedFrameworksTitle: "推荐框架",
    recommendedFrameworksHint:
      "推荐结果会根据所选行业、目标市场以及 AI 相关业务自动生成。",
  ...
  ar: {
    ...
    coreSystemsPlaceholder:
      "مثال: ERP، CRM، HIS، منصة تجارة إلكترونية (افصل بفواصل)",
    requiredFieldsNotice:
      "يرجى تعبئة الحقول المطلوبة: اسم الشركة، القطاع، وإطار أمن سيبراني واحد على الأقل.",
    recommendedFrameworksTitle: "الأطر الموصى بها",
    recommendedFrameworksHint:
      "يتم إنشاء التوصيات تلقائياً بناءً على الصناعة المختارة والسوق المستهدف والأنشطة المرتبطة بالذكاء الاصطناعي.",
...
const INDUSTRY_FRAMEWORK_MAP: Record<
  string,
  Array<(typeof FRAMEWORK_OPTIONS)[number]>
> = {
...
const DATA_LOCATION_LABELS: Record<
  Locale,
  Record<"Saudi Arabia" | "China" | "US" | "EU" | "APAC" | "Others", string>
> = {
  en: {
...
const GAP_CATEGORY_LABELS: Record<
  Locale,
  Record<GapItem["category"], string>
> = {
  en: {
...
const ASSESSMENT_TEXT_TRANSLATIONS: Record<
  Exclude<Locale, "en">,
  Record<string, string>
> = {
  zh: {
    "Data not hosted in China": "数据未托管在中国境内",
    "Establish data center or use local cloud provider (Alibaba Cloud, Tencent Cloud) for data residency compliance":
      "建议建设中国本地数据中心，或使用本地云服务商（阿里云、腾讯云）以满足数据驻留合规要求。",
    "Foreign cloud providers may violate data sovereignty regulations":
      "使用境外云服务商可能违反数据主权相关规定",
    "Migrate workloads to locally-approved providers (Alibaba, Tencent) or implement local proxy infrastructure":
      "建议将关键工作负载迁移到本地合规云（阿里云、腾讯云），或部署本地代理架构。",
    "CAC (Cybersecurity Assessment and Certification) not implemented":
      "尚未满足 CAC（网络安全评估与认证）要求",
    "Pursue CAC certification from authorized assessment organizations":
      "建议通过授权评估机构推进 CAC 认证。",
    "No encryption standard implemented": "尚未实施统一加密标准",
    "Implement AES-256 encryption for data at rest and in transit":
      "建议对静态和传输数据统一采用 AES-256 加密。",
    "Data residency not fully compliant with CAC requirements":
      "数据驻留尚未完全符合 CAC 要求",
    "Establish full data locality compliance; establish data transfer approvals with regulatory bodies if needed":
      "建议完善数据本地化合规，并在必要时办理数据出境审批。",
    "CITC (Communications and Information Technology Commission) requirements not addressed":
      "尚未覆盖 CITC（通信和信息技术委员会）相关要求",
    "Align with CITC cybersecurity standards; consider registering as CITC-compliant entity":
      "建议对齐 CITC 网络安全标准，并评估完成 CITC 合规登记。",
    "SDAIA governance not documented for AI initiatives":
      "AI 项目缺少 SDAIA 治理文件",
    "Implement SDAIA-compliant AI governance framework and documentation":
      "建议建立并落地符合 SDAIA 要求的 AI 治理框架与文档。",
    "Critical services data not hosted in Saudi Arabia":
      "关键业务数据未托管在沙特境内",
    "Establish Saudi Arabia data centers for critical services; use local cloud providers or data residency agreements":
      "建议为关键业务部署沙特本地数据中心，或采用本地云与数据驻留协议。",
    "Full data residency documentation not provided for vision 2030 initiatives":
      "未提供 Vision 2030 相关项目所需的完整数据驻留文件",
    "Document data residency compliance for Vision 2030 and NEOM-related operations":
      "建议补齐 Vision 2030 与 NEOM 相关业务的数据驻留合规文档。",
    "No cross-border data transfer mechanism established":
      "尚未建立跨境数据传输机制",
    "Implement Standard Contractual Clauses (SCC), Binding Corporate Rules (BCR), or equivalent mechanisms":
      "建议落地 SCC、BCR 或同等跨境传输机制。",
    "On-premise hosting may limit scalability for market entry":
      "本地部署可能限制市场进入阶段的扩展能力",
    "Consider hybrid or cloud model for faster deployment and geographic expansion":
      "建议采用混合云或云化模式，以提升部署速度和区域扩展能力。",
    "Traditional monolithic architecture may impact time-to-market":
      "传统单体架构可能影响上市/入市速度",
    "Consider microservices or modern architecture patterns for faster iteration":
      "建议采用微服务或现代架构模式，提高迭代效率。",
  },
  ar: {
    "Data not hosted in China": "البيانات غير مستضافة داخل الصين",
    "Establish data center or use local cloud provider (Alibaba Cloud, Tencent Cloud) for data residency compliance":
      "أنشئ مركز بيانات داخل الصين أو استخدم مزوداً محلياً (Alibaba Cloud أو Tencent Cloud) للامتثال لمتطلبات توطين البيانات.",
    "Foreign cloud providers may violate data sovereignty regulations":
      "قد يؤدي استخدام مزودي سحابة أجانب إلى مخالفة متطلبات سيادة البيانات",
    "Migrate workloads to locally-approved providers (Alibaba, Tencent) or implement local proxy infrastructure":
      "انقل الأحمال إلى مزودين محليين معتمدين (Alibaba أو Tencent) أو طبّق بنية وكيل محلية.",
    "CAC (Cybersecurity Assessment and Certification) not implemented":
      "لم يتم تطبيق متطلبات CAC (التقييم والاعتماد السيبراني)",
    "Pursue CAC certification from authorized assessment organizations":
      "ابدأ إجراءات اعتماد CAC عبر جهات تقييم معتمدة.",
    "No encryption standard implemented": "لا يوجد معيار تشفير مطبق",
    "Implement AES-256 encryption for data at rest and in transit":
      "طبّق تشفير AES-256 للبيانات المخزنة والمنقولة.",
    "Data residency not fully compliant with CAC requirements":
      "امتثال توطين البيانات غير مكتمل وفق متطلبات CAC",
    "Establish full data locality compliance; establish data transfer approvals with regulatory bodies if needed":
      "استكمل امتثال توطين البيانات بالكامل، واستصدر موافقات نقل البيانات من الجهات التنظيمية عند الحاجة.",
    "CITC (Communications and Information Technology Commission) requirements not addressed":
      "متطلبات CITC (هيئة الاتصالات وتقنية المعلومات) غير مستوفاة",
    "Align with CITC cybersecurity standards; consider registering as CITC-compliant entity":
      "واءم الضوابط مع معايير CITC وادرس التسجيل كجهة متوافقة.",
    "SDAIA governance not documented for AI initiatives":
      "توثيق حوكمة SDAIA لمبادرات الذكاء الاصطناعي غير مكتمل",
    "Implement SDAIA-compliant AI governance framework and documentation":
      "طبّق إطار حوكمة للذكاء الاصطناعي متوافقاً مع SDAIA مع توثيق كامل.",
    "Critical services data not hosted in Saudi Arabia":
      "بيانات الخدمات الحرجة غير مستضافة داخل السعودية",
    "Establish Saudi Arabia data centers for critical services; use local cloud providers or data residency agreements":
      "أنشئ استضافة محلية للخدمات الحرجة داخل السعودية أو استخدم مزودين محليين واتفاقيات توطين بيانات.",
    "Full data residency documentation not provided for vision 2030 initiatives":
      "لا تتوفر وثائق كاملة لتوطين البيانات لمبادرات رؤية 2030",
    "Document data residency compliance for Vision 2030 and NEOM-related operations":
      "وثّق امتثال توطين البيانات لمبادرات رؤية 2030 ومشاريع NEOM.",
    "No cross-border data transfer mechanism established":
      "لا توجد آلية معتمدة لنقل البيانات عبر الحدود",
    "Implement Standard Contractual Clauses (SCC), Binding Corporate Rules (BCR), or equivalent mechanisms":
      "طبّق بنود SCC أو قواعد BCR أو آليات مكافئة لنقل البيانات عبر الحدود.",
    "On-premise hosting may limit scalability for market entry":
      "الاستضافة المحلية قد تحد من قابلية التوسع عند دخول السوق",
    "Consider hybrid or cloud model for faster deployment and geographic expansion":
      "فكّر في نموذج سحابي أو هجين لتسريع الإطلاق والتوسع الجغرافي.",
    "Traditional monolithic architecture may impact time-to-market":
      "البنية التقليدية أحادية الكتلة قد تؤخر وقت دخول السوق",
    "Consider microservices or modern architecture patterns for faster iteration":
      "اعتمد بنية حديثة مثل الخدمات المصغرة لتسريع دورات التطوير.",
  },
};
...
function localizeAssessmentText(text: string, locale: Locale): string {
  ...
  const criticalRegex =
    /^CRITICAL: Address (\d+) critical compliance\/infrastructure issues immediately before market entry\.$/;
...
function analyzeComplianceGaps(
  ...
  if (targetCountry === "SA") {
    ...
    if (
      profile.businessActivities.includes("AI") &&
      !compliance.cybersecurityFrameworks.includes("SDAIA")
    ) {
      gaps.push({
        category: "Compliance",
        severity: "Medium",
    ...
    if (
      profile.businessActivities.some(a => {
        ...
        return (
          ...
          normalized.includes("critical infra")
        );
      }) &&
    ...
    if (
      profile.businessActivities.includes("Technology") ||
      profile.businessActivities.includes("Innovation")
    ) {
      if (compliance.dataResidencyStatus !== "Full") {
        gaps.push({
          category: "Compliance",
  ...
  if (
    compliance.crossBorderTransferMechanism === "None" &&
    profile.hqCountry !== profile.targetCountry
  ) {
    gaps.push({
      category: "Compliance",
      severity: "High",
  ...
  if (
    infrastructure.hostingModel === "OnPremise" &&
    profile.companySize === "Startup"
  ) {
    gaps.push({
...
function calculateRiskScores(
  ...
  marketEntryReadiness -=
    gaps.filter(g => g.category === "Infrastructure").length * 10;
  marketEntryReadiness -=
    gaps.filter(g => g.severity === "Critical").length * 15;
  ...
  complianceRisk +=
    gaps.filter(g => g.category === "Compliance" && g.severity === "Critical")
      .length * 25;
  complianceRisk +=
    gaps.filter(g => g.category === "Compliance" && g.severity === "High")
      .length * 15;
  complianceRisk +=
    gaps.filter(g => g.category === "Compliance" && g.severity === "Medium")
      .length * 5;
  complianceRisk = Math.min(100, complianceRisk);

  // Infrastructure Readiness (0-100)
  let infrastructureReadiness = 100;
  if (infrastructure.hostingModel === "OnPremise")
    infrastructureReadiness -= 20;
  if (infrastructure.networkArchitecture === "Traditional")
    infrastructureReadiness -= 15;
  if (profile.companySize === "Startup") infrastructureReadiness -= 10;
  infrastructureReadiness -=
    gaps.filter(g => g.category === "Infrastructure").length * 5;
...
function generateRecommendations(gaps: GapItem[]): string[] {
  ...
  if (criticalGaps.length > 0) {
    recommendations.push(
      `CRITICAL: Address ${criticalGaps.length} critical compliance/infrastructure issues immediately before market entry.`
    );
  }
...
function buildAssessmentResult(
  ...
  let readinessLevel: "NotReady" | "Partial" | "Ready" | "FullyReady" =
    "NotReady";
...
function RiskBadge({
  ...
  const colorMap: Record<string, string> = {
    ...
    Medium:
      "bg-yellow-100 dark:bg-yellow-950/50 text-yellow-800 dark:text-yellow-300 border-yellow-300 dark:border-yellow-800/40",
    ...
    Critical:
      "bg-red-100 dark:bg-red-950/50 text-red-800 dark:text-red-300 border-red-300 dark:border-red-800/40",
  };
  ...
  return (
    <div
      className={`border rounded-lg p-4 flex items-center gap-3 ${colorMap[level]}`}
    >
      {iconMap[level]}
...
export default function VendorAssessment() {
  ...
  const [otherDataHostingLocationsError, setOtherDataHostingLocationsError] =
    useState("");
  ...
  const recommendedFrameworks = useMemo(() => {
    const recommended = new Set<string>(
      INDUSTRY_FRAMEWORK_MAP[profile.industry] ?? []
    );
  ...
  const completionSteps = useMemo(() => {
    ...
    compliance.cybersecurityFrameworks.length,
  ]);

  const completionPercentage = Math.round((completionSteps / 4) * 100);
  const executiveSummary = assessment
    ? getExecutiveSummary(assessment, localeKey, COPY[localeKey])
    : "";
  ...
  const addOtherCloudProviders = () => {
    ...
    if (duplicates.length > 0) {
      setOtherCloudProvidersError(
        `${copy.fields.duplicateValues}: ${duplicates.join(", ")}`
      );
  ...
  const removeOtherCloudProvider = (provider: string) => {
    setInfrastructure({
      ...infrastructure,
      otherCloudProviders: infrastructure.otherCloudProviders.filter(
        item => item !== provider
      ),
    });
    setOtherCloudProvidersError("");
  ...
  const addOtherDataHostingLocations = () => {
    const parsed = splitInputValues(
      infrastructure.otherDataHostingLocationsText
    );
    if (parsed.length === 0) {
  ...
  const removeOtherDataHostingLocation = (location: string) => {
    setInfrastructure({
      ...infrastructure,
      otherDataHostingLocations:
        infrastructure.otherDataHostingLocations.filter(
          item => item !== location
        ),
    });
    setOtherDataHostingLocationsError("");
  ...
  const handleStartAssessment = () => {
    if (formComplete) {
      const pendingCustomProviders = splitInputValues(
        infrastructure.otherCloudProvidersText
      );
      const pendingCustomLocations = splitInputValues(
        infrastructure.otherDataHostingLocationsText
      );
  ...
  return (
    <div
      dir={direction}
      className={`djac-page ${direction === "rtl" ? "text-right" : "text-left"}`}
    >
      <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid gap-6 px-6 py-8 md:grid-cols-[1.4fr_0.8fr] md:px-8">
            ...
            <div className="grid gap-3 sm:grid-cols-3 md:grid-cols-1">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-sm">
                ...
                <p className="mt-2 text-sm font-semibold">
                  {compliance.cybersecurityFrameworks.length} selected
                </p>
              </div>
            </div>
          </div>
        ...
        {formStep === "input" ? (
          ...
          <div className="djac-section-2 space-y-6">
            <div className="grid gap-4 lg:grid-cols-[1.5fr_0.9fr]">
              <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5 shadow-sm">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                      Build a complete market-entry profile before running the
                      risk model.
                    </p>
                  </div>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                  {[
                    {
                      label: "Company",
                      complete: profile.companyName.trim().length > 0,
                    },
                    {
                      label: "Industry",
                      complete: profile.industry.trim().length > 0,
                    },
                    {
                      label: "Jurisdiction",
                      complete: profile.targetCountry.length > 0,
                    },
                    {
                      label: "Frameworks",
                      complete: compliance.cybersecurityFrameworks.length > 0,
                    },
                  ].map(item => (
                    <div
                      key={item.label}
              ...
              <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5 shadow-sm">
                ...
                <ul className="mt-4 space-y-3 text-sm text-slate-600 dark:text-slate-400">
                  <li>
                    Recommended frameworks adapt to the chosen industry and
                    jurisdiction.
                  </li>
                  <li>
                    Results separate infrastructure readiness from pure
                    compliance exposure.
                  </li>
                  <li>
                    The final output prioritizes immediate blockers before
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={v =>
                        setProfile({
                          ...profile,
                          companySize: v as CompanyProfile["companySize"],
                        })
                      }
                    >
                      <SelectTrigger className="w-full">
                  ...
                  <div>
                    ...
                    <Select
                      value={profile.operationalModel}
                      onValueChange={v =>
                        setProfile({
                          ...profile,
                          operationalModel:
                            v as CompanyProfile["operationalModel"],
                        })
                      }
                    >
                      <SelectTrigger className="w-full">
                      ...
                      <SelectContent>
                        <SelectItem value="OnPremise">
                          {copy.options.onpremise}
                        </SelectItem>
                        ...
                        <SelectItem value="MultiCloud">
                          {copy.options.multicloud}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {BUSINESS_ACTIVITY_OPTIONS.map(activity => (
                      ...
                      >
                        <Checkbox
                          checked={profile.businessActivities.includes(
                            activity.value
                          )}
                          onCheckedChange={() => {
                            const updated = profile.businessActivities.includes(
                              activity.value
                            )
                              ? profile.businessActivities.filter(
                                  a => a !== activity.value
                                )
                              : [...profile.businessActivities, activity.value];
                            setProfile({
                              ...profile,
                              businessActivities: updated,
                            });
                          }}
                        />
                        <label className="text-sm cursor-pointer">
                          {activity.labels[localeKey]}
                        </label>
                      </div>
                    ))}
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      value={infrastructure.networkArchitecture}
                      onValueChange={v =>
                        setInfrastructure({
                          ...infrastructure,
                          networkArchitecture:
                            v as ITInfrastructure["networkArchitecture"],
                        })
                      }
                    >
                      <SelectTrigger className="w-full">
                      ...
                      <SelectContent>
                        <SelectItem value="Traditional">
                          {copy.options.traditional}
                        </SelectItem>
                        <SelectItem value="Modern">
                          {copy.options.modern}
                        </SelectItem>
                        <SelectItem value="Distributed">
                          {copy.options.distributed}
                        </SelectItem>
                        <SelectItem value="Serverless">
                          {copy.options.serverless}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
                    ...
                    <Select
                      value={infrastructure.hostingModel}
                      onValueChange={v =>
                        setInfrastructure({
                          ...infrastructure,
                          hostingModel: v as ITInfrastructure["hostingModel"],
                        })
                      }
                    >
                      <SelectTrigger className="w-full">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={provider} className="flex items-center gap-2">
                        <Checkbox
                          checked={infrastructure.currentCloudProviders.includes(
                            provider
                          )}
                          onCheckedChange={() => {
                            const isSelected =
                              infrastructure.currentCloudProviders.includes(
                                provider
                              );
                            const updated = isSelected
                              ? infrastructure.currentCloudProviders.filter(
                                  p => p !== provider
                                )
                              : [
                                  ...infrastructure.currentCloudProviders,
                                  provider,
                                ];
                          ...
                          {provider === "AWS"
                            ...
                            : provider === "Azure"
                              ...
                              : provider === "GCP"
                                ? copy.options.gcp
                                : provider === "Alibaba"
                                  ? copy.options.alibaba
                                  : provider === "Tencent"
                                    ? copy.options.tencent
                                    : copy.options.others}
                        </label>
                      </div>
                    ))}
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row">
                        <Input
                          ...
                          onChange={e => {
                            setInfrastructure({
                              ...infrastructure,
                              otherCloudProvidersText: e.target.value,
                            });
                          ...
                          placeholder={
                            copy.fields.otherCloudProvidersPlaceholder
                          }
                          className="w-full"
                        />
                        <Button
                        ...
                        <div className="flex flex-wrap gap-2 pt-1">
                          {infrastructure.otherCloudProviders.map(provider => (
                            <Badge
                              ...
                              className="bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 gap-1 pr-1"
                            >
                              <span>{provider}</span>
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <button
                                    ...
                                    onClick={() =>
                                      removeOtherCloudProvider(provider)
                                    }
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {(
                      ...
                      >
                        <Checkbox
                          checked={infrastructure.dataHostingLocations.includes(
                            locationKey
                          )}
                          onCheckedChange={() => {
                            const isSelected =
                              infrastructure.dataHostingLocations.includes(
                                locationKey
                              );
                            const updated = isSelected
                              ? infrastructure.dataHostingLocations.filter(
                                  l => l !== locationKey
                                )
                              : [
                                  ...infrastructure.dataHostingLocations,
                                  locationKey,
                                ];
                        ...
                        />
                        <label className="text-sm cursor-pointer">
                          {dataLocationLabels[locationKey]}
                        </label>
                      </div>
                    ))}
                  </div>
                  {infrastructure.dataHostingLocations.includes("Others") && (
                    <div className="mt-3 space-y-2 rounded-lg border border-dashed border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900/50 p-3">
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row">
                        <Input
                          ...
                          onChange={e => {
                            setInfrastructure({
                              ...infrastructure,
                              otherDataHostingLocationsText: e.target.value,
                            });
                          ...
                          placeholder={
                            copy.fields.otherDataHostingLocationsPlaceholder
                          }
                          className="w-full"
                        />
                        <Button
                      ...
                      {infrastructure.otherDataHostingLocations.length > 0 && (
                        <div className="flex flex-wrap gap-2 pt-1">
                          {infrastructure.otherDataHostingLocations.map(
                            location => (
                              <Badge
                                key={`hosting-location-${location}`}
                                className="bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 gap-1 pr-1"
                              >
                                <span>{location}</span>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <button
                                      ...
                                      onClick={() =>
                                        removeOtherDataHostingLocation(location)
                                      }
                                      className="ml-1 inline-flex h-5 w-5 items-center justify-center rounded-full text-gray-600 dark:text-gray-400 transition-colors hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
                                    >
                                      <X
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      value={compliance.dataResidencyStatus}
                      onValueChange={v =>
                        setCompliance({
                          ...compliance,
                          dataResidencyStatus:
                            v as ComplianceProfile["dataResidencyStatus"],
                        })
                      }
                    >
                      <SelectTrigger className="w-full">
                  ...
                  <div>
                    ...
                    <Select
                      value={compliance.crossBorderTransferMechanism}
                      onValueChange={v =>
                        setCompliance({
                          ...compliance,
                          crossBorderTransferMechanism:
                            v as ComplianceProfile["crossBorderTransferMechanism"],
                        })
                      }
                    >
                      <SelectTrigger className="w-full">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="StandardContractualClauses">
                          {copy.options.scc}
                        </SelectItem>
                        <SelectItem value="BindingCorporateRules">
                          {copy.options.bcr}
                        </SelectItem>
                        <SelectItem value="Other">
                          {copy.options.other}
                ...
                <div>
                  ...
                  <p className="mb-3 text-xs text-gray-500 dark:text-gray-400">
                    {uiText.recommendedFrameworksHint}
                  </p>
                  <div className="mb-4 flex flex-wrap gap-2 rounded-lg border border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 p-3">
                    {recommendedFrameworks.length > 0 ? (
                      recommendedFrameworks.map(framework => {
                        const isSelected =
                          compliance.cybersecurityFrameworks.includes(
                            framework
                          );
                        return (
                          <Badge
                            ...
                            className={
                              isSelected
                                ? "bg-emerald-100 dark:bg-emerald-950/50 text-emerald-800 dark:text-emerald-300 hover:bg-emerald-100 dark:hover:bg-emerald-900/50"
                                : "bg-sky-100 dark:bg-sky-950/50 text-sky-800 dark:text-sky-300 hover:bg-sky-100 dark:hover:bg-sky-900/50"
                            }
                          >
                            {framework}
                          </Badge>
                      ...
                      <span className="text-sm text-gray-500 dark:text-gray-400">
                        {uiText.recommendationReady}
                      </span>
                    )}
                  </div>

                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">
                    {copy.fields.cybersecurityFrameworks}{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {FRAMEWORK_OPTIONS.map(framework => (
                      <div key={framework} className="flex items-center gap-2">
                        <Checkbox
                          checked={compliance.cybersecurityFrameworks.includes(
                            framework
                          )}
                          onCheckedChange={() => {
                            const updated =
                              compliance.cybersecurityFrameworks.includes(
                                ...
                                ? compliance.cybersecurityFrameworks.filter(
                                    f => f !== framework
                                  )
                                : [
                                    ...compliance.cybersecurityFrameworks,
                            ...
                            setCompliance({
                              ...compliance,
                              cybersecurityFrameworks: updated,
                            });
                          }}
                        />
                        <label className="text-sm cursor-pointer font-mono">
                          {framework}
                        </label>
                      </div>
                    ))}
                ...
                <div>
                  ...
                  <Select
                    value={compliance.encryptionStandard}
                    onValueChange={v =>
                      setCompliance({
                        ...compliance,
                        encryptionStandard:
                          v as ComplianceProfile["encryptionStandard"],
                      })
                    }
                  >
                    <SelectTrigger className="w-full">
            ...
            {!formComplete && (
              <div
                className="rounded-lg border-l-4 border-yellow-400 dark:border-yellow-600 bg-yellow-50 dark:bg-yellow-950/30 p-4"
                role="alert"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    {copy.results.marketEntryReadiness}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <ScoreGauge
                    score={assessment.scores.marketEntryReadiness}
                    label="0-100"
                    locale={locale}
                  />
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    {copy.results.infrastructureReadiness}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <ScoreGauge
                    score={assessment.scores.infrastructureReadiness}
                    label="0-100"
                    locale={locale}
                  />
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    {copy.results.complianceRisk}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <ScoreGauge
                    score={assessment.scores.complianceRisk}
                    label={`${copy.results.riskLevel}: 0-100`}
                    locale={locale}
                  />
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    {copy.results.readinessLevel}
                  </CardTitle>
                </CardHeader>
                <CardContent className="flex items-center justify-center">
                  <Badge className="text-lg px-4 py-2">
                    {assessment.readinessLevel === "NotReady" &&
                      copy.results.notReady}
                    {assessment.readinessLevel === "Partial" &&
                      copy.results.partial}
                    {assessment.readinessLevel === "Ready" &&
                      copy.results.ready}
                    {assessment.readinessLevel === "FullyReady" &&
                      copy.results.fullyReady}
                  </Badge>
                </CardContent>
              </Card>
            </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                      <div className="text-center p-3 bg-red-50 dark:bg-red-950/30 rounded-lg">
                        <p className="text-2xl font-bold text-red-600 dark:text-red-400">
                          {
                            assessment.gaps.filter(
                              g => g.severity === "Critical"
                            ).length
                          }
                        </p>
                        <p className="text-xs text-red-700 dark:text-red-400">
                          {copy.gaps.criticalCount}
                        </p>
                      </div>
                      <div className="text-center p-3 bg-orange-50 dark:bg-orange-950/30 rounded-lg">
                        <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                          {
                            assessment.gaps.filter(g => g.severity === "High")
                              .length
                          }
                        </p>
                      ...
                      <div className="text-center p-3 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg">
                        <p className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">
                          {
                            assessment.gaps.filter(g => g.severity === "Medium")
                              .length
                          }
                        </p>
                        <p className="text-xs text-yellow-700 dark:text-yellow-400">
                          {copy.gaps.mediumCount}
                        </p>
                      </div>
                      <div className="text-center p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
                        <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                          {
                            assessment.gaps.filter(g => g.severity === "Low")
                              .length
                          }
                        </p>
                    ...
                    {assessment.gaps.map((gap, idx) => (
                      ...
                      >
                        ...
                        <p className="font-medium text-gray-900 dark:text-gray-100">
                          {localizeAssessmentText(gap.finding, localeKey)}
                        </p>
                  ...
                  {assessment.recommendations.map((rec, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        {localizeAssessmentText(rec, localeKey)}
                      </p>
                    </li>
                  ))}
                </ul>
            ...
            {/* Action Buttons */}
            <div className="flex gap-4 justify-center">
              <Button size="lg" onClick={handleReset} className="px-8">
                {copy.fields.reset}
              </Button>
            </div>
          </div>
