        ...
        {isLoggedIn && currentPlan === "free_trial" && trialDays > 0 && (
          <div
            style={{
              ...
              borderRadius: 10,
              background:
                "linear-gradient(90deg,rgba(34,211,238,0.12),rgba(168,85,247,0.12))",
          ...
          >
            ...
            <span style={{ color: "#c4b5fd" }}>
              ...
              {t("pricing.trialRemaining", "remaining in your free trial.")}{" "}
              {t(
                "pricing.upgradeKeepAccess",
        ...
        >
          {PLANS.map(plan => {
            ...
            const isPending =
              ...
              createCheckout.variables?.plan === plan.key;
            ...
            return (
              ...
              >
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  >
                    {t(`pricing.plan.${plan.key}.name`, plan.name)}
                  </h3>
                  <p
                    style={{
                      fontSize: 13,
                ...
                <div style={{ marginBottom: 24 }}>
                  ...
                  >
                    ...
                    >
                      {t(
                        `pricing.plan.${plan.key}.price.${interval}`,
                        priceInfo.label
                      )}
                    </span>
                    {plan.key !== "enterprise" && (
                      <span
                        style={{ fontSize: 14, color: "var(--djac-muted)" }}
                      >
                        /
                        {interval === "monthly"
                          ? t("pricing.perMonth", "mo")
                          : interval === "quarterly"
                            ? t("pricing.perQuarter", "qtr")
                            : interval === "biannual"
                              ? t("pricing.perHalfYear", "6mo")
                              : t("pricing.perYear", "yr")}
                      </span>
                    )}
                  </div>
                  {priceInfo.savings && (
                    ...
                    >
                      {t(
                        `pricing.plan.${plan.key}.savings.${interval}`,
                        priceInfo.savings
                      )}
                    </div>
                  )}
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Real-time scoring & gap identification",
              },
              {
                icon: <FileText size={20} />,
                title: "PDF Reports",
                desc: "Executive-ready compliance reports, instantly",
              },
              {
                icon: <Users size={20} />,
                title: "Team Collaboration",
                desc: "RBAC roles for your entire compliance team",
              },
              {
                icon: <Lock size={20} />,
                title: "Enterprise Security",
                desc: "Encrypted at rest & in transit, full audit logs",
              },
              {
                icon: <HeadphonesIcon size={20} />,
                title: "Expert Support",
                desc: "Email, chat & dedicated compliance consultant",
              },
            ].map((item, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <div>
                  ...
                  >
                    {t(`pricing.why.${idx + 1}.title`, item.title)}
                  </div>
                  <div
                    style={{
                      fontSize: 12,
                  ...
                  >
                    {t(`pricing.why.${idx + 1}.desc`, item.desc)}
                  </div>
                </div>
              </div>
            ))}
