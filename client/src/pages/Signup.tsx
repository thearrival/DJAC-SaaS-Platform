...
function PasswordField({
  ...
  const strLabel = str?.label
    ? t(`signup.strength${str.label}`, str.label)
    : "";
  return (
    <div>
      <div style={{ position: "relative" }}>
        ...
        <input
          ...
          style={{
            ...mkWithIcon(C, dir),
            ...(dir === "rtl" ? { paddingLeft: 40 } : { paddingRight: 40 }),
          }}
            ...
            {[1, 2, 3].map(i => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 99,
                  background:
                    str && str.score >= i * 1.5 ? str.color : C.border,
...
const ROLE_DEFS: RoleDef[] = [
  {
    ...
    descFallback:
      "Manage obligations, track regulatory gaps, and generate audit-ready compliance reports.",
    badgeFallback: "Compliance & Privacy",
  ...
  },
  {
    ...
    descFallback:
      "Research cross-border regulations, advise clients, and track legislative changes in real time.",
    badgeFallback: "Legal Profession",
    userType: "professional",
  },
  {
    id: "company",
    ...
    descFallback:
      "Register your organization, manage multi-team access, and centralize compliance obligations.",
    badgeFallback: "Corporate Entity",
    userType: "professional",
  },
  {
    id: "government",
    ...
    descFallback:
      "Access regulatory frameworks, monitor cross-border market participants, and enforce obligations.",
    badgeFallback: "Public Authority",
    userType: "professional",
  },
  {
    id: "consultant",
    ...
    descFallback:
      "Serve multiple clients from a single compliance workspace with multi-tenant case management.",
    badgeFallback: "Consulting Services",
    userType: "professional",
  },
  {
    id: "vendor",
    ...
    descFallback:
      "Validate your compliance posture, share assessments with partners, and manage certifications.",
    badgeFallback: "Supply Chain",
    userType: "professional",
  },
  {
    id: "visitor",
    ...
    descFallback:
      "Explore public compliance frameworks, regulatory databases, and reference documentation.",
    badgeFallback: "Public Access",
    userType: "visitor",
  },
];
...
function SecurityNotice({ C }: { C: DesignTokens }) {
  ...
  return (
    ...
    >
      <ShieldCheck
        size={13}
        style={{ color: C.cyan, flexShrink: 0, marginTop: 1 }}
      />
      <p
        style={{ margin: 0, fontSize: 10.5, color: C.muted, lineHeight: 1.55 }}
      >
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: 10.5, color: C.muted, lineHeight: 1.55 }}>
        ...
        <Link href="/terms">
          <span style={{ color: C.cyan, textDecoration: "underline" }}>
            {t("signup.termsConsent.terms", "Terms of Service")}
          </span>
        </Link>{" "}
        {t("signup.termsConsent.and", "and")}{" "}
        <Link href="/privacy">
          <span style={{ color: C.cyan, textDecoration: "underline" }}>
            {t("signup.termsConsent.privacy", "Privacy Policy")}
          </span>
        </Link>
        {". "}
        {t(
          "signup.termsConsent.legal",
          "This constitutes a binding legal agreement under applicable national laws."
        )}
      </span>
    </label>
  );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <div>
        ...
        <p style={{ color: C.muted, fontSize: 12.5, margin: 0 }}>
          {t(
            "signup.chooseRole.sub",
            "Your role determines workspace features, compliance templates, and data access permissions."
          )}
        </p>
      </div>
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        <div>
          ...
          >
            {t("signup.totpTitle", "Two-Factor Authentication")}
          </h2>
        ...
        >
          <div style={{ position: "relative" }}>
            ...
            <input
              ...
              value={totpCode}
              onChange={e =>
                setTotpCode(e.target.value.replace(/\s/g, "").slice(0, 10))
              }
          ...
          <button
            ...
            style={{
              background: verifyTotpMut.isPending
                ? `${C.cyan}60`
              ...
              fontWeight: 800,
              fontSize: 14,
              cursor: verifyTotpMut.isPending ? "not-allowed" : "pointer",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              gap: 8,
          ...
          >
            <Shield size={15} />{" "}
            {verifyTotpMut.isPending
              ? t("signup.verifying", "Verifying...")
              : t("signup.verifyCode", "Verify Code")}
          </button>
          <button
            type="button"
            onClick={() => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <div>
        ...
        >
          {t("signup.welcomeBack", "Welcome back")}
        </h2>
        <p style={{ color: C.muted, fontSize: 13, margin: 0 }}>
          {t("signup.signInSub", "Sign in to your DJAC compliance workspace.")}
        </p>
      </div>
      <form
      ...
      >
        ...
        />
        <div
          style={{ textAlign: dir === "rtl" ? "start" : "end", marginTop: -6 }}
        >
          <Link
        ...
        <button
          type="submit"
          disabled={loginMut.isPending || !database.ready}
          className="djac-btn-primary"
          style={{
        ...
        >
          <LogIn size={15} />{" "}
          {loginMut.isPending
            ? t("signup.signingIn", "Signing in...")
            : t("signup.signIn", "Sign In")}
        </button>
        <p
          role="status"
          aria-live="polite"
          style={{ color: C.muted, fontSize: 11, margin: 0 }}
        >
          {loginMut.isPending
            ? t("signup.authBusy", "Authentication in progress...")
            : ""}
        </p>
        {!database.ready ? (
          <p role="alert" style={{ color: C.red, fontSize: 12, margin: 0 }}>
      ...
      <p
        style={{ color: C.muted, fontSize: 12, textAlign: "center", margin: 0 }}
      >
...
function RoleRegisterForm({
    ...
    onSuccess: data => {
      if ("pendingVerification" in data && data.pendingVerification) {
        ...
        if ("otpCode" in data && data.otpCode) {
          ...
          setOtpMessage(
            "otpMessage" in data && typeof data.otpMessage === "string"
              ? data.otpMessage
              : ""
          );
        }
        ...
        setTourPending();
        sonnerToast.success(
          t("signup.accountCreated", "Account created! Welcome to DJAC.")
        );
        navigate(safeReturnTo);
      }
    },
  ...
  const TagButton = ({
    ...
    <button
      ...
      style={{
        ...
        borderRadius: 7,
        color: active ? tagAccent : C.muted,
        fontSize: 11,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (role !== "visitor" && !dataConsent) {
      setError(
        t(
          "signup.mustAcceptDataConsent",
          "Data processing consent is required for professional accounts."
        )
      );
      return;
    }
    ...
    if (roleDef.userType === "professional" && effectiveTitle.length < 2) {
      setError(
        t("signup.errorJobTitleMin", "Job title must be at least 2 characters.")
      );
      return;
    }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        ...
        >
          <ChevronLeft size={13} />{" "}
          {pendingVerification
            ? t("signup.backToForm", "Edit details")
            : t("signup.back", "Back")}
        </button>
        {!pendingVerification && (
          <div
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            ...
            <div>
              ...
              >
                {t(
                  "signup.otpSentBody",
                  "A 6-digit code has been sent to {email}. Enter it below to activate your account."
                ).replace("{email}", email)}
              </p>
            </div>
          </div>
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 800,
              fontSize: 14,
              cursor: verifyOtpMut.isPending ? "not-allowed" : "pointer",
          ...
          >
            ...
            {verifyOtpMut.isPending
              ? t("signup.verifying", "Verifying...")
              : t("signup.activateAccount", "Activate Account")}
          </button>
          <button
            type="button"
            onClick={() => {
          ...
          >
              ...
              <>
                ...
                <div>
                  <p style={sectionLabel}>
                    {t("signup.jurisdictions", "Primary Jurisdictions")}
                  </p>
            ...
            {role === "lawyer" && (
              <>
                ...
                <div>
                  <p style={sectionLabel}>
                    {t("signup.practiceAreas", "Areas of Practice")}
                  </p>
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                    {PRACTICE_AREAS.map(a => (
                      <TagButton
                        ...
                        label={a}
                        tagAccent={accent}
                        active={selectedTags.includes(a)}
                        onToggle={() =>
                          toggleTag(selectedTags, setSelectedTags, a)
                        }
                      />
                    ))}
                  </div>
                ...
                >
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <input
                      required
                      value={countryHQ}
                      onChange={e => setCountryHQ(e.target.value)}
                      placeholder={t(
                        "signup.countryHQ",
            ...
            {role === "government" && (
              <>
                ...
                >
                  <AlertCircle
                    size={13}
                    style={{ color: C.yellow, flexShrink: 0, marginTop: 1 }}
                  />
                  <p
                    style={{
                      margin: 0,
                  ...
                  >
                    {t(
                      "signup.govNote",
                      "Government accounts are subject to manual verification. Please use your official government-issued email address. Access will be activated within 1–3 business days."
                    )}
                  </p>
                </div>
              </>
            ...
            {role === "consultant" && (
              <>
                ...
                <div>
                  <p style={sectionLabel}>
                    {t("signup.advisoryAreas", "Advisory Areas")}
                  </p>
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                    {PRACTICE_AREAS.map(a => (
                      <TagButton
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                    {CERT_OPTIONS.map(c => (
                      <TagButton
                        ...
                        onToggle={() =>
                          toggleTag(certifications, setCertifications, c)
                        }
                      />
                    ))}
                  </div>
            ...
            <button
              type="submit"
              disabled={regMut.isPending || !database.ready}
              className="djac-btn-primary"
              style={{
                background: regMut.isPending
                  ? `${accent}60`
                ...
                fontWeight: 800,
                fontSize: 14,
                cursor: regMut.isPending ? "not-allowed" : "pointer",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                gap: 8,
            ...
            >
              ...
              {regMut.isPending
                ...
                : t("signup.createAccountCta", "Create Account")}
            </button>
            <p
              role="status"
              aria-live="polite"
...
function IpRegistrationSection({ C }: { C: DesignTokens }) {
  return (
    ...
    >
      ...
      >
        This platform is officially registered and protected under international
        intellectual property authorities, ensuring authenticity, trust, and
        legal ownership.
      </p>
        ...
        {[
          ...
          >
            ...
            >
              Registered under
              <br />
              <strong style={{ color: C.text, fontSize: 8.5 }}>
                {card.name}
                <br />
                {card.name2}
              </strong>
...
export default function Signup() {
      ...
      try {
        ...
        if (active) {
          setDatabase({
            ready: false,
            details: t(
              "signup.databaseCheckFailed",
              "Could not verify database readiness. Check backend connectivity."
            ),
          });
        }
      }
  ...
  const VALUE_PROPS = [
    ...
    },
    {
      icon: <Zap size={17} />,
      accent: C.yellow,
      title: t("signup.vp2Title", "Risk Scoring & Gap Analysis Engine"),
      desc: t(
        "signup.vp2Desc",
        "Automated compliance gap detection with severity scoring and remediation guidance."
      ),
    },
    {
      icon: <BarChart2 size={17} />,
      accent: C.purple,
      title: t("signup.vp3Title", "Automated Reporting & Evidence Export"),
      desc: t(
        "signup.vp3Desc",
        "Board-ready reports in PDF, DOCX, and Excel with full audit trail packages."
      ),
    },
    {
      icon: <BookOpen size={17} />,
      accent: C.green,
      title: t("signup.vp4Title", "Built for Government & Enterprise"),
      desc: t(
        "signup.vp4Desc",
        "Purpose-built for compliance officers, DPOs, and legal teams operating cross-border."
      ),
    },
    {
      icon: <Lock size={17} />,
      accent: C.orange,
      title: t("signup.vp5Title", "Secure Access with Audit-Grade Tracking"),
      desc: t(
        "signup.vp5Desc",
        "Enterprise MFA, RBAC, and immutable audit logs ensuring regulatory-grade accountability."
      ),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="djac-left-panel"
          style={{
            padding: "52px 48px 48px 8px",
            display: "flex",
            flexDirection: "column",
            justifyContent: "center",
          }}
        >
          ...
          >
            {t("signup.heroLine1", "Enterprise-Grade Compliance")}
            <br />
        ...
        >
          ...
          >
            ...
            <div
              role="tablist"
              aria-label={t("signup.tabSwitcher", "Account type")}
              style={{
                display: "flex",
                gap: 3,
                marginBottom: 28,
            ...
            >
              {TABS.map(tp => (
                <button
                  ...
                  aria-controls={`signup-panel-${tp.id}`}
                  onClick={() => switchTab(tp.id)}
                  style={{
                    flex: 1,
            ...
            >
              {[
                ...
                <div key={s.lf} style={{ textAlign: "center" }}>
                  ...
                  <p style={{ color: C.muted, fontSize: 10.5, margin: 0 }}>
                    {t(s.lk, s.lf)}
                  </p>
                </div>
              ))}
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <ShieldCheck size={11} style={{ color: C.cyan }} />© 2026 DJAC ·
