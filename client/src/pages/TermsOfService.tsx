      ...
      >
        ...
        >
          ...
          <Section title="1. Acceptance of Terms" C={C}>
            <p>
              By creating an account or accessing the DJAC platform ("
              <strong>Service</strong>") operated by Yalla Hack ("
              <strong>Company</strong>"), you agree to be bound by these Terms
              of Service ("<strong>Terms</strong>"). If you do not agree, you
          ...
          <Section title="2. Description of Service" C={C}>
            ...
            <p>
              <strong>
                The Service provides informational tools only. Nothing in the
                Service constitutes legal advice, and use of the Service does
                not create an attorney-client relationship.
              </strong>{" "}
              You should consult qualified legal counsel for specific legal
              questions.
            </p>
          </Section>
          ...
          <Section title="3. Account Registration" C={C}>
            ...
            <p>
              ...
              these Terms or that we reasonably believe pose a security or
              operational risk.
            </p>
          </Section>
          ...
          <Section title="4. Subscription and Billing" C={C}>
            <p>
              ...
              bi-annual, or annual basis as selected at checkout. All fees are
              non-refundable except as required by applicable law or as
              expressly stated in a separate written agreement.
            </p>
            <p>
              We use Stripe as our payment processor. By subscribing, you agree
              to Stripe's terms of service and authorize us to charge your
          ...
          <Section title="5. Acceptable Use" C={C}>
            ...
            <ul style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              ...
              <li>
                Submit malicious content, malware, or content designed to
              ...
              <li>
                Use automated tools to scrape, crawl, or data-mine the Service.
              </li>
              <li>
                Upload data that infringes third-party intellectual property
                rights.
              </li>
            </ul>
          </Section>
          ...
          <Section title="6. Intellectual Property" C={C}>
            <p>
              The Service, including all software, algorithms, reports, and
              visual design, is the exclusive property of Yalla Hack and its
              licensors. Nothing in these Terms transfers ownership of any
              intellectual property to you.
            </p>
            <p>
              You retain ownership of data and documents you submit to the
              Service ("<strong>Your Content</strong>"). By submitting Your
          ...
          <Section title="7. Confidentiality" C={C}>
            <p>
              We treat Your Content as confidential. We will not disclose Your
              Content to third parties except as described in our Privacy Policy
              or as required by law. We implement administrative, technical, and
              physical safeguards appropriate to the sensitivity of the data.
            </p>
          </Section>
          ...
          <Section title="8. Disclaimers" C={C}>
            ...
            <p>
              ...
              error-free; (b) AI-generated assessments are complete, accurate,
              or legally definitive; or (c) the Service fulfils any specific
          ...
          <Section title="9. Limitation of Liability" C={C}>
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, YALLA HACK'S
              TOTAL LIABILITY TO YOU FOR ALL CLAIMS ARISING FROM OR RELATED TO
              THE SERVICE SHALL NOT EXCEED THE AMOUNT YOU PAID TO US IN THE
              TWELVE (12) MONTHS PRECEDING THE CLAIM.
            </p>
            <p>
              IN NO EVENT SHALL YALLA HACK BE LIABLE FOR INDIRECT, INCIDENTAL,
          ...
          <Section title="10. Indemnification" C={C}>
            <p>
              You agree to indemnify, defend, and hold harmless Yalla Hack and
              ...
              these Terms; (b) Your Content; or (c) your violation of applicable
              law.
            </p>
          </Section>
          ...
          <Section title="11. Termination" C={C}>
            ...
            <p>
              On request made within 30 days of termination, we will provide an
              export of Your Content in a standard format.
            </p>
          </Section>
          ...
          <Section title="12. Governing Law and Dispute Resolution" C={C}>
            <p>
              ...
              Arabia, without regard to conflict-of-law principles. Any dispute
              arising from these Terms or the Service shall first be subject to
              good-faith negotiation. If unresolved within 30 days, disputes
              shall be submitted to binding arbitration in Riyadh, KSA,
          ...
          <Section title="13. Changes to Terms" C={C}>
            <p>
              We may modify these Terms at any time. We will provide at least 30
              days' notice of material changes by email or in-app notification.
          ...
          <Section title="14. Contact" C={C}>
            ...
            <p>
              <strong>Yalla Hack</strong>
              <br />
              Email: legal@yallahack.com
              <br />
            </p>
          </Section>
