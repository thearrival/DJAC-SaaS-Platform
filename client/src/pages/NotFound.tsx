    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(ellipse, rgba(147,89,236,0.14) 0%, transparent 70%)",
          filter: "blur(48px)",
          pointerEvents: "none",
        }}
      />
      ...
      >
        ...
        >
          {t(
            "notfound.message",
            "This page doesn't exist or was moved. Head back to the dashboard to continue."
          )}
        </p>
        ...
        >
          <button
            ...
            style={{
              ...
              gap: 7,
              fontSize: "0.9rem",
              boxShadow: "0 4px 20px rgba(147,89,236,0.30)",
            }}
          >
