...
export default function VendorDetail() {
  ...
  const patchMutation = trpc.vendor.patch.useMutation({
    ...
    onError: err => {
      toast.error(
        t("vendorDetail.updateError", "Failed to update vendor.") +
          ": " +
          err.message
      );
    },
  ...
  const deleteMutation = trpc.vendor.delete.useMutation({
    ...
    onError: err => {
      toast.error(
        t("vendorDetail.deleteError", "Failed to delete vendor.") +
          ": " +
          err.message
      );
    },
  ...
  function openEdit(vendor: {
    ...
    setEditForm({
      ...
      criticalityLevel: (vendor.criticalityLevel ?? "") as
    ...
    return (
      <div className="p-8 flex items-center justify-center gap-3 text-muted-foreground">
        ...
        <span className="text-sm">
          {t("vendorDetail.loading", "Loading vendor profile…")}
        </span>
      </div>
    );
  }
    ...
    return (
      <div className="p-8 flex flex-col items-center gap-4 text-center">
        ...
        <QueryErrorPanel
          message={
            detailQuery.error?.message ??
            t("vendorDetail.notFound", "Vendor not found.")
          }
          onRetry={
            detailQuery.error
              ? () => {
    ...
    <div className="djac-page">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge
              className={`text-xs ${STATUS_CLASS[assessment.status] ?? ""}`}
            >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <ChipList
                  label={t(
                    "vendorDetail.fieldCloudProviders",
                    "Cloud Providers"
                  )}
                ...
                <ChipList
                  label={t(
                    "vendorDetail.fieldOperatingCountries",
                    "Operating Countries"
                  )}
            ...
            <Card>
              ...
              <CardContent>
                <ChipList
                  label={t(
                    "vendorDetail.fieldJurisdictions",
                ...
                <ChipList
                  label={t(
                    "vendorDetail.fieldCertifications",
                    "Certifications"
                  )}
                ...
                <ChipList
                  label={t(
                    "vendorDetail.fieldDataActivities",
          ...
          {assessment.recommendations.length > 0 && (
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  {t(
                    "vendorDetail.recommendationsDesc",
                    "Priority actions to improve compliance posture"
                  )}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            {assessment.gaps.length === 0 ? (
              <Card>
                <CardContent className="py-10 text-center">
                  ...
                  <p className="text-sm font-medium">
                    {t(
                      "vendorDetail.noGapsTitle",
                      "No compliance gaps detected"
                    )}
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">
                    {t(
                      "vendorDetail.noGapsDesc",
                      "This vendor meets all assessed framework requirements."
                    )}
                  </p>
                </CardContent>
              </Card>
              ...
              <div className="space-y-2">
                {(["critical", "high", "medium", "low"] as Severity[]).map(
                  sev => {
                    const gaps = assessment.gaps.filter(
                      g => g.severity === sev
                    );
            ...
            <Card>
              <CardContent className="py-10 text-center">
                ...
                <p className="text-sm font-medium text-muted-foreground">
                  {t(
                    "vendorDetail.noTechStack",
                    "No tech stack components registered"
                  )}
                </p>
                <p className="text-xs text-muted-foreground mt-1">
                  {t(
                    "vendorDetail.noTechStackDesc",
                    "Add technology components when registering the vendor."
                  )}
                </p>
              </CardContent>
            </Card>
      ...
      <Sheet open={editOpen} onOpenChange={setEditOpen}>
        <SheetContent className="sm:max-w-md overflow-y-auto">
          <SheetHeader>
            <SheetTitle>
              {t("vendorDetail.editTitle", "Edit Vendor Profile")}
            </SheetTitle>
            <SheetDescription>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-1.5">
              <Label htmlFor="edit-name">
                {t("vendorDetail.fieldName", "Vendor Name")}
              </Label>
              <Input
                id="edit-name"
                value={editForm.vendorName}
                onChange={e =>
                  setEditForm(f => ({ ...f, vendorName: e.target.value }))
                }
              />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="edit-desc">
                {t("vendorDetail.fieldDescription", "Description")}
              </Label>
              <Textarea
                id="edit-desc"
                rows={3}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="edit-contact-name">
                {t("vendorDetail.fieldContactName", "Contact Name")}
              </Label>
              <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="edit-contact-email">
                {t("vendorDetail.fieldContactEmail", "Contact Email")}
              </Label>
              <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="edit-contact-role">
                {t("vendorDetail.fieldContactRole", "Contact Role")}
              </Label>
              <Input
                ...
                onChange={e =>
                  setEditForm(f => ({
                    ...f,
                    primaryContactRole: e.target.value,
                  }))
                }
              />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="edit-contact-phone">
                {t("vendorDetail.fieldContactPhone", "Phone")}
              </Label>
              <Input
            ...
            <div className="space-y-1.5">
              <Label>
                {t("vendorDetail.fieldCriticality", "Criticality Level")}
              </Label>
              <Select
                ...
                onValueChange={v =>
                  setEditForm(f => ({
                    ...f,
                    criticalityLevel: v as VendorCriticalityLevel,
                  }))
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={v =>
                  setEditForm(f => ({ ...f, riskTier: v as VendorRiskTier }))
                }
              >
                <SelectTrigger>
          ...
          <SheetFooter>
            ...
            <Button
              ...
              disabled={
                ...
                !editForm.vendorName.trim() ||
                !editForm.criticalityLevel ||
                !editForm.riskTier
              }
            >
              {patchMutation.isPending && (
      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("vendorDetail.deleteTitle", "Delete Vendor?")}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t(
                "vendorDetail.deleteDesc",
                "This will permanently remove the vendor and all assessment data. This cannot be undone."
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
