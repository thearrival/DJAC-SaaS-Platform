...
function MatrixRain({ className }: { className?: string }) {
  ...
  return (
    <canvas ref={canvasRef} className={className} style={{ opacity: 0.035 }} />
  );
}
  ...
  return (
    <div className="relative w-64 h-64 flex items-center justify-center">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg,rgba(59,130,246,.18),rgba(16,185,129,.14))",
          border: "1px solid rgba(99,157,255,.45)",
          boxShadow:
            "0 0 36px rgba(59,130,246,.35), inset 0 0 18px rgba(59,130,246,.1)",
...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="text-[1.85rem] font-extrabold tracking-tight mb-1 font-[Inter]"
        style={{ color }}
      >
        {prefix}
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hov
          ? `0 12px 40px ${accent}1e, inset 0 0 28px ${accent}06`
          : "none",
...
const FEED: { t: string; msg: string; s: "ok" | "warn" | "err" }[] = [
  {
    t: "00:00:01",
    msg: "GDPR Art. 32 compliance scan — 0 critical gaps",
    s: "ok",
  },
  {
    t: "00:00:03",
  ...
  {
    t: "00:00:06",
    msg: "Vendor risk update: Acme Corp → score 87 / 100",
    s: "warn",
  },
  {
    t: "00:00:09",
    msg: "AI pipeline: 12 frameworks processed in 4.1 s",
    s: "ok",
  },
  {
    t: "00:00:12",
    msg: "Transfer check: EU→US data flow — SCCs required ⚠",
    s: "warn",
  },
  {
    t: "00:00:15",
    msg: "PDPA (TH) conformity: 94 % — above threshold",
    s: "ok",
  },
  {
    t: "00:00:18",
    msg: "Audit log sealed: 247 policy events recorded",
    s: "ok",
  },
  {
    t: "00:00:21",
    msg: "Incident register: 1 low-severity event opened",
    s: "err",
  },
  {
    t: "00:00:24",
    msg: "ISO 27001 gap scan: 2 controls remain open",
    s: "warn",
  },
  {
    t: "00:00:27",
    msg: "Smart-contract processor flagged for DPA review",
    s: "err",
  },
];
      ...
      <div className="p-4 font-mono text-xs space-y-1.5 max-h-60 overflow-hidden">
        {FEED.map((item, i) => (
          ...
          >
            ...
            <span style={{ color: sColor[item.s], flexShrink: 0 }}>
              {sGlyph[item.s]}
            </span>
            <span
...
function ScoreGauge({ score = 98.4 }: { score?: number }) {
  ...
  return (
    <div
      ...
      style={{ animation: "ring-appear .9s ease .4s both" }}
    >
        ...
        {Array.from({ length: 30 }, (_, i) => {
          ...
          return (
            <line
              ...
              x2={120 + 84 * Math.cos(a)}
              y2={120 + 84 * Math.sin(a)}
              stroke="rgba(99,157,255,.28)"
...
export default function DJACHero() {
  ...
  return (
    <>
      ...
      <div
        className="djac-page relative min-h-screen overflow-x-hidden"
      ...
      >
        ...
        <div className="fixed inset-0 -z-10">
          ...
          {/* Fine grid */}
          <div
            className="absolute inset-0 opacity-[.022] pointer-events-none"
            style={{
              backgroundImage:
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-28 text-center">
          ...
          >
            <div
              className="w-1.5 h-1.5 rounded-full bg-green-400"
              style={{ animation: "glow-green 1.5s ease-in-out infinite" }}
            />
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom,rgba(99,157,255,.55),transparent)",
              }}
            />
          </div>
        </section>
        ...
        <section className="relative px-6 py-24">
          <div className="max-w-6xl mx-auto">
            <div
              ...
              style={{ animation: "slide-up .6s ease both" }}
            >
              <div
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div style={{ animation: "slide-up .7s ease both" }}>
              ...
              <p
                ...
                style={{ color: "hsl(var(--muted-foreground))" }}
              >
                Stream live audit events, AI decisions, risk scoring updates,
                and cross-border transfer flags — all in one immutable,
                timestamped compliance feed.
              </p>
              <DataFeed />
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p
                ...
                style={{ color: "hsl(var(--muted-foreground))" }}
              >
                React 19 · TypeScript strict · tRPC 11 · Drizzle ORM · MariaDB ·
                Express 4 · Tailwind CSS 4 · shadcn/ui · Wouter · Sonner
              </p>
        ...
        >
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-5">
            ...
            <p
              ...
              style={{ color: "hsl(var(--muted-foreground))" }}
            >
              © 2026 Yalla-Hack · Compliance data is jurisdiction-specific and
