...
function TLPBadge({ tlp }: { tlp: string }) {
  return (
    <Badge variant="outline" className={TLP_COLORS[tlp] ?? ""}>
      TLP:{tlp.toUpperCase()}
    </Badge>
  );
}
...
function ItemFormFields({
  ...
  form: ItemForm;
  onChange: (f: Partial<ItemForm>) => void;
}) {
  return (
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="e.g. Critical RCE in Apache HTTPD…"
        />
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="space-y-1.5">
          ...
          <Select
            value={form.category}
            onValueChange={v =>
              onChange({ category: v as ItemForm["category"] })
            }
          >
            <SelectTrigger>
              <SelectValue />
        ...
        <div className="space-y-1.5">
          ...
          <Select
            value={form.severity}
            onValueChange={v =>
              onChange({ severity: v as ItemForm["severity"] })
            }
          >
            <SelectTrigger>
              <SelectValue />
        ...
        <div className="space-y-1.5">
          ...
          <Select
            value={form.tlp}
            onValueChange={v => onChange({ tlp: v as ItemForm["tlp"] })}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            onChange={e => onChange({ threatActor: e.target.value })}
        ...
        <div className="space-y-1.5">
          ...
          <Input
            value={form.cveId}
            onChange={e => onChange({ cveId: e.target.value })}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            onChange={e => onChange({ cvssScore: e.target.value })}
            placeholder="9.8"
          />
        </div>
        <div className="space-y-1.5">
          ...
          <Input
            value={form.affectedSectors}
            onChange={e => onChange({ affectedSectors: e.target.value })}
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          rows={3}
          placeholder="One indicator per line: IP, hash, domain, file name…"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-xs text-muted-foreground">
          Leave Organization ID empty to publish a global bulletin visible to
          all orgs.
        </p>
        <Input
          type="number"
...
export default function AdminThreatIntel() {
  ...
  const {
    ...
    isError,
    refetch,
  } = trpc.threatIntel.feed.useQuery(
    { limit: 200 },
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Publish and manage threat bulletins visible to client
              organizations
            </p>
          </div>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <Button
                              ...
                              title={
                                item.isActive ? "Archive" : "Already archived"
                              }
                              disabled={
                                !item.isActive || removeMutation.isPending
                              }
                              onClick={() =>
