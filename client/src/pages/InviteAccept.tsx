    ...
    return (
      <InviteLayout>
        <InvalidCard
          ...
          description={t(
            "inviteAccept.invalidDesc",
            "This invitation link is not recognized or may have already been used."
          )}
        />
      </InviteLayout>
    );
        ...
        <Card className="w-full max-w-md border-border shadow-xl">
          <CardContent className="pt-10 pb-10 flex flex-col items-center gap-4">
            ...
            <p className="text-muted-foreground">
              {t("inviteAccept.loadingTitle", "Loading invitation...")}
            </p>
          </CardContent>
        </Card>
      </InviteLayout>
          ...
          <CardContent className="pt-10 pb-10 flex flex-col items-center gap-4 text-center">
            ...
            <div>
              <h2 className="text-xl font-bold text-foreground">
                {t(
                  "inviteAccept.lookupLoadErrorTitle",
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {lookup.error?.message ??
                  t(
                    "inviteAccept.lookupLoadErrorDesc",
                    "Please retry to verify this invitation link."
                  )}
              </p>
            </div>
            <Button
    ...
    return (
      <InviteLayout>
        <InvalidCard
          ...
          description={t(
            "inviteAccept.expiredDesc",
            "This invitation link has expired. Contact the organization admin for a new one."
          )}
          ...
          >
            {acceptMut.isPending ? (
              <>
                ...
                {t("inviteAccept.accepting", "Accepting...")}
              </>
            ) : (
