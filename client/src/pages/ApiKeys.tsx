...
const ALL_SCOPES: { value: Scope; label: string; desc: string }[] = [
  {
    value: "vendor:read",
    label: "vendor:read",
    desc: "Read vendor profiles and assessments",
  },
  {
    value: "vendor:write",
    label: "vendor:write",
    desc: "Create and update vendors",
  },
  {
    value: "report:read",
    label: "report:read",
    desc: "Read compliance reports",
  },
  {
    value: "report:write",
    label: "report:write",
  ...
  },
  {
    ...
    desc: "Read assessment jobs and results",
  },
  {
    value: "assessment:write",
    label: "assessment:write",
    desc: "Trigger assessments",
  },
  {
    value: "compliance:read",
    label: "compliance:read",
    desc: "Read frameworks and controls",
  },
  {
    value: "admin:read",
    label: "admin:read",
    desc: "Read admin/org stats (read-only)",
  },
];
...
export default function ApiKeys() {
  ...
  useEffect(() => {
    if (listQuery.error)
      toast.error(t("apiKeys.loadError", "Failed to load API keys."));
  }, [listQuery.error]);
          ...
          {listQuery.isError ? (
            ...
            >
              ...
              <p style={{ fontSize: 12 }}>
                {t(
                  "apiKeys.noKeysHint",
                  "Create a key to enable CI/CD integrations."
                )}
              </p>
            </div>
          ) : (
