      ...
      >
        ...
        >
          ...
          <Section title="1. Introduction" C={C}>
            <p>
              Yalla Hack ("<strong>we</strong>", "<strong>us</strong>", or "
              <strong>our</strong>") operates the DJAC (Dual Jurisdiction
              Compliance) platform ("<strong>Service</strong>"). This Privacy
              Policy explains how we collect, use, store, and protect your
              personal information when you access or use the Service.
            </p>
            <p>
          ...
          <Section title="2. Information We Collect" C={C}>
            ...
            <p>
              When you register, we collect: full name, work email address,
              company name, job title, and a hashed password (bcrypt). We never
            ...
            <p>
              ...
              the Service, including: pages visited, features used, compliance
              queries submitted, AI assessment results, session duration, and
              browser/device type.
            </p>

            <SubHeading C={C}>2.3 Payment Information</SubHeading>
            <p>
              Billing transactions are processed by Stripe, Inc. We do not store
              credit card numbers or payment instrument details on our servers.
              We receive and store only Stripe customer IDs, subscription
              status, and billing metadata.
            </p>

            <SubHeading C={C}>2.4 Compliance Data You Upload</SubHeading>
            <p>
              You may submit documents, vendor information, or business details
              to receive compliance assessments. This data is processed to
              provide the Service and is subject to the data handling
          ...
          <Section title="3. Legal Bases for Processing" C={C}>
            <p>
              ...
              (where applicable under GDPR, PIPL, and PDPL):
            </p>
          ...
          <Section title="4. How We Use Your Information" C={C}>
            ...
            <p>
              ...
              parties. We do not use your compliance input data to train
          ...
          <Section title="5. Data Retention" C={C}>
            <p>
              ...
              or as needed to provide the Service. Interaction logs and AI query
              history are automatically purged after <strong>90 days</strong> by
              default (configurable by your organization administrator). Upon
              account deletion, personal data is removed within 30 days subject
          ...
          <Section title="6. Data Sharing" C={C}>
            ...
            <ul style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              <li>
                <strong>Stripe</strong> — payment processing (Stripe Privacy
                Policy: stripe.com/privacy).
              </li>
              <li>
                <strong>SMTP service provider</strong> — transactional email
                delivery.
              </li>
              <li>
          ...
          <Section title="8. Your Rights" C={C}>
            ...
            <p>
              ...
              <strong>privacy@yallahack.com</strong>.
            </p>
          </Section>
          ...
          <Section title="9. Security" C={C}>
            <p>
              ...
              encryption in transit, bcrypt password hashing, JWT-based session
              tokens, HTTP security headers (CSP, HSTS, X-Frame-Options), and
              role-based access controls. However, no system is completely
          ...
          <Section title="10. Cookies" C={C}>
            <p>
              The Service uses HTTP-only session cookies for authentication. We
              do not use third-party tracking or advertising cookies. You may
          ...
          <Section title="12. Changes to This Policy" C={C}>
            <p>
              ...
              notify registered users of material changes by email or prominent
              notice within the Service at least 30 days before the changes take
              effect. The "Last updated" date at the top of this page will
          ...
          <Section title="13. Contact" C={C}>
            <p>
              For privacy inquiries, data subject requests, or to reach our Data
              Protection Officer:
            </p>
            <p>
              <strong>Yalla Hack</strong>
              <br />
              Email: privacy@yallahack.com
              <br />
            </p>
          </Section>
