          ...
          {step === "done" ? (
            ...
            >
              ...
              <div style={{ textAlign: "center", marginBottom: 20 }}>
                ...
                >
                  <ShieldCheck size={10} />{" "}
                  {t("forgot.verifyBadge", "OTP Verification")}
                </div>
                <h2
                  style={{
                    fontSize: 22,
              ...
              >
                ...
                {error && (
                  <p
                    role="alert"
                    style={{ color: C.red, fontSize: 12, margin: 0 }}
                  >
                    {error}
                  </p>
                )}
                ...
                >
                  {resetMutation.isPending
                    ? t("forgot.resetting", "Resetting...")
                    : t("forgot.resetButton", "Reset Password")}
                </button>
              </form>
            ...
            >
              ...
              <div style={{ textAlign: "center", marginBottom: 20 }}>
                ...
                >
                  <ShieldCheck size={10} />{" "}
                  {t("forgot.badge", "Secure Account Recovery")}
                </div>
                <h2
                  style={{
                    fontSize: 22,
              ...
              >
                ...
                >
                  <strong style={{ color: C.cyan }}>
                    {t("forgot.notice.header", "Privacy Protected")}
                  </strong>
                  {" · "}
                  {t(
                    "forgot.notice.body",
                    "For security, we never confirm whether an email is registered. A code will only be sent if an account exists."
                  )}
                </p>
              </div>
              <form
              ...
              >
                ...
                >
                  {sendMutation.isPending
                    ? t("forgot.sending", "Sending code...")
                    : t("forgot.sendButton", "Send Reset Code")}
                </button>
                <p
                  role="status"
                  aria-live="polite"
