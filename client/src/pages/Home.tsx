...
export default function Home() {
  ...
  const accessRequestMutation = trpc.portal.submitAccessRequest.useMutation({
    onSuccess: () => {
      sonnerToast.success(
        t("home.toast.accessRequested", "Access request submitted")
      );
    ...
    onError: err => {
      sonnerToast.error(
        t(
          "home.errors.accessRequestFailed",
  ...
  const publicConsultationMutation =
    trpc.portal.submitConsultationRequest.useMutation({
      onSuccess: () => {
        sonnerToast.success(
          t(
            "home.toast.consultationRequested",
      ...
      onError: err => {
        sonnerToast.error(
          t(
            "home.errors.consultationFailed",
  ...
  const authenticatedConsultationMutation =
  ...
  const submitAccessRequest = async () => {
    if (
      ...
      sonnerToast.error(
        t(
          "home.errors.accessFormIncomplete",
          "Complete name, email, and organization fields."
        )
      );
      return;
    }
  ...
  const submitConsultationRequest = async () => {
    if (
      ...
      sonnerToast.error(
        t(
          "home.errors.consultationFormIncomplete",
  ...
  const isConsultationSubmitting =
    publicConsultationMutation.isPending ||
    authenticatedConsultationMutation.isPending;
  ...
  return (
    <div
      style={{
        background: `linear-gradient(180deg, ${C.bgDeep} 0%, ${C.bg} 25%, ${C.bg} 75%, ${C.bgDeep} 100%)`,
        minHeight: "100vh",
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "radial-gradient(rgba(0,247,255,0.035) 1px, transparent 1px)",
      ...
      <div
        style={{
          ...
          height: 500,
          background:
            "radial-gradient(ellipse, rgba(147,89,236,0.18) 0%, transparent 65%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 11 }}>
            ...
            >
              DJAC <span style={{ color: C.cyan }}>Tool</span>
            </span>
          </div>
          <div
            className="djac-home-nav-actions"
            ...
            {effectivelyAuthenticated ? (
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span style={{ color: C.muted, fontSize: 12 }}>
                  {t("home.welcome", "Welcome")}, {effectiveUser?.name}
                </span>
                <Link href="/dashboard">
                  <button
                    style={{
                  ...
                  >
                    {t("home.goToDashboard", "Dashboard")}{" "}
      ...
      >
        ...
        >
          ...
          <span
            style={{
              background: `linear-gradient(130deg, ${C.cyan}, ${C.purple})`,
        ...
        <div
          className="djac-home-hero-actions"
          style={{
            display: "flex",
            gap: 12,
          ...
          {effectivelyAuthenticated ? (
            <>
              <Link href="/dashboard">
                <button
                  style={{
                    background: `linear-gradient(130deg, ${C.cyan}DD, ${C.purple})`,
                    border: "none",
                    borderRadius: 12,
                    color: "#fff",
                    padding: "14px 28px",
                ...
                >
                  {t("home.viewDashboard", "Open Dashboard")}{" "}
            ...
            <>
              <Link href="/signup">
                <button
                  style={{
                    background: `linear-gradient(130deg, ${C.cyan}CC, ${C.purple})`,
                    border: "none",
                    borderRadius: 12,
                    color: "#fff",
                    padding: "14px 28px",
        ...
        {/* Stats row */}
        <div
          className="djac-home-stats-grid"
          style={{
            display: "grid",
        ...
        >
          {[
            ...
            {
              v: "Real-time",
              l: t("home.statsRealtimeLabel", "Live Monitoring"),
            },
          ].map(s => (
            <div
              key={s.v}
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <p style={{ color: C.muted, fontSize: 14 }}>
            {t(
              "home.platformNote",
              "Covering CSL · PIPL · DSL · PDPL · NCA · MLPS 2.0"
            )}
          </p>
        </div>
        <div
          className="djac-home-feature-grid"
          style={{
            display: "grid",
          ...
          {[
            {
              ...
              accent: C.cyan,
              title: t(
                "home.featureComparativeTitle",
                "Side-by-Side Framework Comparison"
              ),
              body: t(
                "home.featureComparativeDesc",
                "Pick any two frameworks and instantly see what overlaps, what conflicts, and exactly what you need to do about it — no legal jargon."
              ),
            },
            {
              icon: <GitBranch style={{ width: 24, height: 24 }} />,
              accent: C.purple,
              title: t(
                "home.featureVisualTitle",
                "Conflict & Dependency Mapping"
              ),
              body: t(
                "home.featureVisualDesc",
                "Our relationship engine maps 10+ framework pairs to surface hidden legal conflicts before they become regulatory surprises or fines."
              ),
            },
            {
              ...
              accent: C.yellow,
              title: t(
                "home.featureVendorTitle",
                "Market Entry Readiness Check"
              ),
              body: t(
                "home.featureVendorDesc",
                "AI-powered assessment of your tech stack and operations against every applicable framework obligation — know your gaps before you launch."
              ),
            },
          ].map(f => (
            <div
            ...
            >
              ...
              <h3
                style={{ fontSize: 16.5, fontWeight: 700, margin: "0 0 10px" }}
              >
                {f.title}
              </h3>
              <p
      ...
      <section
        style={{
          position: "relative",
          zIndex: 1,
          background: "var(--djac-section-alt)",
          padding: "72px 28px",
        }}
      >
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div
            className="djac-home-steps-grid"
            style={{
              display: "grid",
              gridTemplateColumns: "repeat(3,1fr)",
              gap: 40,
            ...
            {[
              {
                num: "01",
                color: C.cyan,
                icon: <LogIn style={{ width: 28, height: 28 }} />,
                title: t("home.step1Title", "Sign In Securely"),
                desc: t(
                  "home.step1Desc",
                  "Secure enterprise login with role-based access. No shared passwords, no compliance shortcuts."
                ),
              },
              {
                num: "02",
              ...
              },
              {
                num: "03",
                color: C.green,
                icon: <TrendingUp style={{ width: 28, height: 28 }} />,
                title: t("home.step3Title", "Get Clear, Actionable Answers"),
                desc: t(
                  "home.step3Desc",
                  "See conflicts, track obligations, assess tech-stack readiness, and ask our AI assistant — all in one place, in your language."
                ),
              },
            ].map(s => (
              <div key={s.num} style={{ textAlign: "center" }}>
                ...
                <h3
                  style={{ fontSize: 18, fontWeight: 700, margin: "0 0 12px" }}
                >
                  {s.title}
                </h3>
                <p
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            >
              {t(
                "home.intakeSubtitle",
                "Submit your registration or ask for compliance guidance — we typically respond within 24 hours."
              )}
            </p>
          </div>

          <div
            className="djac-home-intake-grid"
          ...
          >
            ...
            >
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: "0 0 6px" }}>
                {t("home.accessCardTitle", "Platform Access Request")}
              </h3>
              <p style={{ color: C.muted, fontSize: 13, margin: "0 0 28px" }}>
                {t(
                  "home.accessCardSubtitle",
                  "Request organization onboarding and platform activation."
                )}
              </p>
              <p style={{ color: C.muted, fontSize: 11.5, margin: "0 0 12px" }}>
                {t(
                  "home.requiredHint",
                  "Required fields: Name, Email, and Organization."
                )}
              </p>
              <div
                className="djac-home-form-grid"
                style={{
                  display: "grid",
              ...
              >
                {(
                  [
                    {
                      label: t("home.fieldFullName", "Full Name"),
                      key: "fullName",
                      type: "text",
                    },
                    {
                      label: t("home.fieldEmail", "Work Email"),
                      key: "email",
                      type: "email",
                    },
                    {
                      label: t("home.fieldOrganization", "Organization"),
                      key: "organizationName",
                      type: "text",
                    },
                    {
                      label: t("home.fieldOrganizationType", "Org Type"),
                      key: "organizationType",
                      type: "text",
                    },
                  ] as {
                    label: string;
                    key: keyof typeof accessForm;
                    type: string;
                  }[]
                ).map(f => (
                  <div key={f.key}>
              ...
              <div style={{ marginBottom: 20 }}>
                <label style={lbl}>
                  {t("home.fieldUseCase", "What will you use it for?")}
                </label>
                <textarea
                  rows={3}
              ...
              <button
                ...
                style={{
                  background: isAccessSubmitting ? `${C.purple}55` : C.purple,
                  border: "none",
                  borderRadius: 10,
                  color: "#fff",
                  padding: "12px 24px",
                  fontWeight: 700,
                  fontSize: 14,
                  cursor: isAccessSubmitting ? "not-allowed" : "pointer",
                  opacity: isAccessSubmitting ? 0.8 : 1,
                  width: "100%",
                }}
              >
                {isAccessSubmitting
                  ? t("home.submitting", "Submitting...")
                  : t("home.submitAccess", "Submit Access Request")}
              </button>
              {isAccessSubmitting && (
                <p
                  style={{
            ...
            >
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: "0 0 6px" }}>
                {t("home.consultationCardTitle", "Compliance Consultation")}
              </h3>
              <p style={{ color: C.muted, fontSize: 13, margin: "0 0 28px" }}>
                {t(
              ...
              >
                {(
                  [
                    {
                      label: t("home.fieldContactName", "Your Name"),
                      key: "contactName",
                      type: "text",
                    },
                    {
                      label: t("home.fieldContactEmail", "Work Email"),
                      key: "contactEmail",
                      type: "email",
                    },
                    {
                      label: t("home.fieldConsultationOrg", "Organization"),
                      key: "organizationName",
                      type: "text",
                    },
                    {
                      label: t("home.fieldTopic", "Topic / Focus"),
                      key: "topic",
                      type: "text",
                    },
                    {
                      label: t("home.fieldVendor", "Vendor (Optional)"),
                      key: "vendorName",
                      type: "text",
                    },
                    {
                      label: t("home.fieldTechStack", "Tech Stack (Optional)"),
                      key: "techStackSummary",
                      type: "text",
                    },
                  ] as {
                    label: string;
                    key: keyof typeof consultationForm;
                    type: string;
                  }[]
                ).map(f => (
                  <div key={f.key}>
                    ...
                    <input
                      type={f.type}
                      value={(consultationForm[f.key] ?? "") as string}
                      onChange={e =>
                        setConsultationForm(prev => ({
                          ...prev,
                          [f.key]: e.target.value,
              ...
              <div style={{ marginBottom: 14 }}>
                <label style={lbl}>
                  {t("home.fieldJurisdictions", "Which jurisdictions apply?")}
                </label>
                <div
                  style={{
                    display: "flex",
                      ...
                      <button
                        ...
                        style={{
                          background: active
                            ? `${C.cyan}25`
                            : "var(--djac-card-hi)",
                          border: `1px solid ${active ? C.cyan + "70" : "var(--djac-border)"}`,
                          borderRadius: 7,
              ...
              <div style={{ marginBottom: 20 }}>
                <label style={lbl}>
                  {t("home.fieldSummary", "Briefly describe your request")}
                </label>
                <textarea
                  rows={3}
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  fontSize: 14,
                  cursor: isConsultationSubmitting ? "not-allowed" : "pointer",
                  opacity: isConsultationSubmitting ? 0.7 : 1,
                  width: "100%",
                }}
              >
                {isConsultationSubmitting
                  ? t("home.submitting", "Submitting...")
                  : t("home.submitConsultation", "Submit Consultation Request")}
              </button>
              {isConsultationSubmitting && (
                <p
                  style={{
      ...
      {effectivelyAuthenticated && (
        ...
        >
          ...
          >
            <h2 style={{ fontSize: 32, fontWeight: 700, margin: "0 0 14px" }}>
              {t("home.ctaTitle", "Your compliance dashboard is ready.")}
            </h2>
            <p
              style={{
                color: C.muted,
            ...
            >
              {t(
                "home.ctaSubtitle",
                "Start analyzing framework conflicts and tracking obligations right now."
              )}
            </p>
            <Link href="/dashboard">
              <button
              ...
              >
                {t("home.accessDashboard", "Go to Dashboard")}{" "}
                <ArrowRight style={{ width: 15, height: 15 }} />
              </button>
            </Link>
          </div>
