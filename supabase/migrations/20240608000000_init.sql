...
-- Organization members can see their organization data
...
-- Organization admins can insert/update
...
CREATE POLICY "service_role_all" ON users
  FOR ALL USING (current_role = 'service_role' OR current_user = 'service_role');
